...
## Project Structure
    ...
    ├── anothergreatniceapp_36358  # Django project configurations
...
1. Clone this repo and `cd anothergreatniceapp_36358`
...
2. Clone this repo and `cd anothergreatniceapp_36358`
